...
func _ready() -> void:
	job_dictionary = {
		...
		"2" = {resources.charname: "Bastard Fist",
			...
			resources.skill_tree: "res://Classes/Bastard Fist/SkillTree-BastardFist.tscn"},
		"3" = {resources.charname: "Strider",
			...
			resources.skill_tree: "res://Classes/Shade Hunter/SkillTree-ShadeHunter.tscn"},
		"4" = {resources.charname: "Redeemer",
			...
			resources.skill_tree: "res://Classes/Erde Cleric/SkillTree-ErdeCleric.tscn"},
		...
		"6" = {resources.charname: "Illusionist",
			...
			resources.label: "res://Assets/Classes/TBD-PartyLabel.png",
			resources.skill_tree: "res://Classes/Illusionist/SkillTree-Illusionist.tscn"},
